                ...
                <div class="col-lg-6 col-md-8 col-12">
                    <div class="agent-description">
                        <div class="agent-text">
                            <p><span class="black">Stephen de Smith</span> is a Specialist Real Estate Agent with <span class="yellow">8 years of      Experience</span> in Real Estate field. He achive success with his honesty,determination, hardwork and commetment.</p>
                        </div>
                        <div class="agent-birography">
                            ...
                            <div class="biography-desc">
                                <p>Stephen de Smith ipsum dolor sit amet, consectetur adipiscing elit, sed      do od tempor incididunt ut labore et dolore magna iqua. Ut enim adini   venia nod exercitation ullamco laboris nisiut some of the systemetic observ simple but she done it very smartly and simply</p>
                            </div>
