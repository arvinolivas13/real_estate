...
@section('content')
 ...
 <div class="breadcrumbs overlay-black agents-cover">
        ...
        <div class="welcome-haven single-services">
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 col-12 welcome-pd agent">
                    ...
                    <div class="col-lg-5 col-12">
                        <div class="welcome-haven-img">
                            <img src="frontend/img/welcome/6.png" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.4s">
                            <div class="team-img">
                                <a href="agent-details.html">
                                    <img src="frontend/img/team/7.jpg" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.5s">
                            <div class="team-img">
                                <a href="agent-details.html">
                                    <img src="frontend/img/team/8.jpg" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.3s">
                            <div class="team-img">
                                <a href="agent-details.html">
                                    <img src="frontend/img/team/9.jpg" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.4s">
                            <div class="team-img">
                                <a href="agent-details.html">
                                    <img src="frontend/img/team/10.jpg" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.5s">
                            <div class="team-img">
                                <a href="agent-details.html">
                                    <img src="frontend/img/team/11.jpg" alt="">
                                </a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                    ...
                    <div class="col-lg-3 col-md-4 col-12">
                        <div class="single-team fadeInUp wow" data-wow-delay="0.3s">
                            <div class="team-img">
                                <a href="agent-details.html"><img src="frontend/img/team/12.jpg" alt=""></a>
                            </div>
                            <div class="team-desc">
                                <div class="team-member-title">
                                    <h6><a href="agent-details.html">Stephen de Smith</a></h6>
