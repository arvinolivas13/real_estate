    ...
    <div class="container">
        ...
        <div class="col-md">
            <div class="ftco-footer-widget mb-4">
                ...
                <ul>
                    <li><span class="icon icon-map-marker"></span><span class="text">2D RNL Bldg. Bagumbayan, Teresa Rizal</span></li>
                    <li><a href="#"><span class="icon icon-phone"></span><span class="text">0917 502 3189</span></a></li>
                    <li><a href="#"><span class="icon icon-envelope"></span><span class="text">info@brilliantfivej.com</span></a></li>
                </ul>
                </div>
            </div>
        </div>
