    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title">Position Maintenance Screen
...
<script>
    ...
    $(function() {
        $('#datatables').DataTable({
            ...
            columns: [
                ...
                { data: "id", title:"Action", render: function(data, type, row, meta) {
                    var html = "";
                    html += '<a href="#" class="align-middle edit" onclick="edit(' + row.id + ')" title="Edit" data-toggle="modal" data-target="#positionModal"><i class="fas fa-pen"></i></a>';
        ...
        $('#save_record').validate({
            submitHandler: function (form) {
                ...
                if(record_id === null) {
                    scion.record.add('/payroll/position/save', formData,
                    function() {
                    ...
                    scion.record.update('/payroll/position/update', record_id, formData,
                    function() {
                        $('#datatables').DataTable().draw();
                        $('#positionModal').modal('hide');
                    },
    ...
    function deleteRecord(id) {
        delete_func = scion.record.delete('/payroll/position/destroy', id,
        function() {
            $('#datatables').DataTable().draw();
        },
        function() {
